...
export var Select = function (props) {
    ...
    return (_jsxs("div", __assign({ className: classNames(cls.Wrapper, mods, [className]) }, { children: [label
                && _jsx("span", __assign({ className: cls.label }, { children: label })), _jsx("select", __assign({ disabled: readonly, className: cls.select, value: value, onChange: onChangeHandler }, { children: optionList }))] })));
};
