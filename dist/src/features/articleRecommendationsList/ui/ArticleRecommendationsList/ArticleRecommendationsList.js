...
export var ArticleRecommendationsList = memo(function (props) {
    ...
    return (_jsxs(VStack, __assign({ gap: "8", className: classNames('', {}, [className]) }, { children: [_jsx(Text, { size: ETextSize.L, title: t('recommendations') }), _jsx(ArticleList, { articles: articles })] })));
});
